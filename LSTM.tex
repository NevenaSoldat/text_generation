...
\begin{figure}[htp]
    \centering
    \includegraphics[scale = 0.5]{konvergencija_20_epoha_100_neurona.png}
...
\begin{figure}[htp]
    \centering
    \includegraphics[scale = 0.5]{konv_50e100n.png}
...
\begin{figure}[htp]
    \centering
    \includegraphics[scale = 0.5]{konv_100e100n.png}
...
% TODO: OVDE TABELA SA RAZLIČITIM BROJEM NEURONA i TAČNOST KOJU MODEL DAJE
% 100, 300, 1000
